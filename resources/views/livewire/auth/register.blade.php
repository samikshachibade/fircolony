<form wire:submit.prevent="register" class="w-full grid grid-cols-4 items-center justify-center gap-5 mt-6">
    <div class="w-full">
    ...
    <div class="w-full">
        ...
        <input type="text" wire:model.lazy="mother_name" id="mother_name"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
    ...
    <div class="w-full">
        ...
        <input type="text" wire:model.lazy="father_name" id="father_name"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
    ...
    <div class="w-full">
        ...
        <input type="text" wire:model.lazy="surname" id="surname"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
            placeholder="Surname">
        <p class="text-xs text-red-500">
            @error('surname')
    ...
    <div class="w-full">
        ...
        <input type="text" wire:model.lazy="address" id="address"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
            placeholder="Address">
        <p class="text-xs text-red-500">
            @error('address')
    ...
    <div class="w-full">
        ...
        <input type="number" wire:model.lazy="aadhaar_number" id="aadhaar_number"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
    ...
    <div class="w-full">
        ...
        <input type="text" wire:model.lazy="pancard_number" id="pancard_number"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
    ...
    <div class="w-full">
        ...
        <select id="state" wire:model="state" wire:change="updateCities"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full">
            <option value="">Select State</option>
            @foreach ($statesAndDistricts as $stateData)
    ...
    <div class="w-full">
        ...
        <input type="number" wire:model.lazy="mobile_number" id="mobile_number"
            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full"
    ...
    <div class="w-full">
        ...
        <p class="text-xs text-red-500">
            @error('password')
                {{ __('Password must 8 charcter long and contain atleast 1-uppercase, 1-lowercase, 1-special Character and 1-number') }}
            @enderror
        </p>
    </div>
    <div class="w-full">
